<section id="about-section" class="bg-white py-12 md:py-16 lg:py-20">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row gap-8 lg:gap-12 xl:gap-16 items-center">
            <!-- Gambar Section -->
            <div class="relative w-full lg:w-1/2 group">
                ...
                <!-- Contact Box - Mobile (below image) -->
                <div class="lg:hidden mt-6 bg-[#474747] text-white p-4 rounded-lg shadow-md">
                ...
                <!-- Contact Box - Desktop (overlay) -->
                <div class="hidden lg:block absolute -bottom-5 left-5 bg-[#474747] text-white p-4 rounded-lg shadow-md w-4/5">
                    <h3 class="text-lg font-bold mb-2">Kontak Kami</h3>
                    <div class="space-y-2">
                        <p class="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="w-full lg:w-1/2 space-y-6">
                <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 leading-tight">
                    <span class="block text-gray-800">Kami Memasak</span>
                    <span class="block text-gray-800">Makanan Enak</span>
                    <span class="block text-gray-800">dan Terjangkau</span>
                </h2>
                ...
                <div class="space-y-4 text-gray-700">
                    ...
                    <div class="bg-orange-50 p-4 rounded-lg border-l-4 border-[#F97316]">
                        <p class="text-base sm:text-lg">
